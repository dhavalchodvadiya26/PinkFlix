...
public class TVDetailsActivity extends AppCompatActivity {
    ...
    HomeTVListAdapter homeSportAdapter;
    String Id;
    ...
    private void displayData() {
        ...
        if (!mListItemRelated.isEmpty()) {
            homeSportAdapter = new HomeTVListAdapter(TVDetailsActivity.this, mListItemRelated);
    ...
    private void initPlayer() {
        if (itemTV.isPremium()) {
            if (isPurchased) {
                ...
                PremiumContentListFragment premiumContentFragment = PremiumContentListFragment.newInstance(Id, "LiveTV",itemTV.getTvType());
    ...
    private void setPlayer() {
        if (itemTV.getTvURL().isEmpty()) {
            EmbeddedImagesFragment embeddedImageFragment = EmbeddedImagesFragment.newInstance(itemTV.getTvURL(), itemTV.getTvImage(), false);
            ...
            switch (itemTV.getTvType()) { //URL Embed
                case "hls":
                    ExoPlayerFragment exoPlayerFragment = ExoPlayerFragment.newInstance(itemTV.getTvURL(),false);
                    fragmentManager.beginTransaction().replace(R.id.playerSection, exoPlayerFragment).commitAllowingStateLoss();
                    break;
                case "embed":
                    EmbeddedImagesFragment embeddedImageFragment = EmbeddedImagesFragment.newInstance(itemTV.getTvURL(), itemTV.getTvImage(), true);
                    fragmentManager.beginTransaction().replace(R.id.playerSection, embeddedImageFragment).commitAllowingStateLoss();
                    break;
                case "youtube":
                    isPlayerIsYt = true;
