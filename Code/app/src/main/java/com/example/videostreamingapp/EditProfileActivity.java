            ...
            public void onClick(View v) {
                ...
                client.post(Constant.EDIT_PROFILE_URL, params, new AsyncHttpResponseHandler() {
                    ...
                    public void onStart() {
                        super.onStart();
                        showProgressDialog();
//                                Toast.makeText(ChangePasswordActivity.this, "JSON Started", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                        ...
                        System.out.println("EditProfileActivity ==> User Result ==> "+result);
                        try {
                            ...
                            Toast.makeText(EditProfileActivity.this, strMessage, Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
                        dismissProgressDialog();
//                                Toast.makeText(ChangePasswordActivity.this, "JSON Failed", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void getUserProfile() {
        ...
        client.post(Constant.PROFILE_URL, params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                String result = new String(responseBody);
                System.out.println("EditProfileActivity ==> result ==> "+result);
                try {
                    JSONObject mainJson = new JSONObject(result);
                    JSONArray jsonArray = mainJson.getJSONArray(Constant.ARRAY_NAME);
