...
public class MovieDetailsActivity2 extends AppCompatActivity implements View.OnClickListener, DialogUtils.AlertDialogListener, DownloadTracker.Listener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getWindow().getDecorView().setSystemUiVisibility(flags);
         mp = MediaPlayer.create(MovieDetailsActivity2.this, R.raw.btn_click);
        ...
        recyclerCast.setLayoutManager(new LinearLayoutManager(MovieDetailsActivity2.this, LinearLayoutManager.HORIZONTAL, false));
...
//        itemMovie=new ItemMovie();
    ...
    protected void createView() {
        ...
        rvRelated.setLayoutManager(new LinearLayoutManager(MovieDetailsActivity2.this, LinearLayoutManager.HORIZONTAL, false));
            ...
            switch (itemMovie.getMovieType()) {
                ...
                case "URL":
                    if (getIntent().getBooleanExtra("live", false)) {
                        ExoTVPlayerFragment exoPlayerFragment = ExoTVPlayerFragment.newInstance(itemMovie.getMovieUrl(), false, currentPosition);
                        ...
                        ExoPlayerFragment exoPlayerFragment = ExoPlayerFragment.newInstance(itemMovie.getMovieUrl(), false, currentPosition);
                        exoPlayerFragment.setItemMovie(itemMovie);
                        fragmentManager.beginTransaction().replace(R.id.frame_layout_main, exoPlayerFragment).commitAllowingStateLoss();
                    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.ll_download_video:
                btnDownloadMovie.startAnimation(AnimationUtils.loadAnimation(MovieDetailsActivity2.this, R.anim.image_click));
                if (NetworkUtils.isConnected(MovieDetailsActivity2.this)) {
                    if (myApplication.getIsLogin()) {
                        if (offlineDatabaseHelper.checkIfMyMovieExists2(itemMovie.getMovieId())) {
                            ...
                            PrettyDialog pDialog = new PrettyDialog(MovieDetailsActivity2.this);
                            pDialog
                        ...
                        pDialog
                                ...
                                .addButton(
                                        ...
                                        () -> {
                                            pDialog.dismiss();
                                            startActivity(new Intent(MovieDetailsActivity2.this, SignInActivity.class));
                                        }).addButton(
            ...
            case R.id.btnWatchList2:
                btnWatchList.startAnimation(AnimationUtils.loadAnimation(MovieDetailsActivity2.this, R.anim.image_click));
                if (NetworkUtils.isConnected(MovieDetailsActivity2.this)) {
                    if (myApplication.getIsLogin())
                        addToWatchList();
                    else {
            ...
            case R.id.btnWatchListselect2:
                btnWatchListselect.startAnimation(AnimationUtils.loadAnimation(MovieDetailsActivity2.this, R.anim.image_click));
                if (NetworkUtils.isConnected(MovieDetailsActivity2.this)) {
                    if (myApplication.getIsLogin())
                        removeToWatchList();
                    else {
            ...
            case R.id.btnShare1:
            case R.id.txtShare1:
                btnShare.startAnimation(AnimationUtils.loadAnimation(MovieDetailsActivity2.this, R.anim.image_click));
            ...
            case R.id.btnLike1:
                ...
                if (NetworkUtils.isConnected(MovieDetailsActivity2.this)) {
                    if (myApplication.getIsLogin()) {
                        btnLike.startAnimation(AnimationUtils.loadAnimation(MovieDetailsActivity2.this, R.anim.image_click));
                        mp.start();
                        likeMovie();
                    } else {
                        PrettyDialog pDialog = new PrettyDialog(MovieDetailsActivity2.this);
            ...
            case R.id.txtDisLike1:
                btnDisLike.startAnimation(AnimationUtils.loadAnimation(MovieDetailsActivity2.this, R.anim.image_click));
                if (NetworkUtils.isConnected(MovieDetailsActivity2.this)) {
                    if (myApplication.getIsLogin())
                        DislikeMovie();
                    else {
    ...
    private void createLink(String movie_id) {
        ...
        DynamicLink dynamicLink = FirebaseDynamicLinks.getInstance().createDynamicLink()
                .setLink(Uri.parse("https://cineprime.app/"))
                .setDomainUriPrefix("https://cineprime.page.link/")
        ...
        Log.e("MovieDetailsActivity2", "Long Refer Link ==> " + dynamicLinkUri);//https://cineprime.page.link/?apn=com.appegic.cprime&ibi=com.example.ios&link=https%3A%2F%2Fcineprime.app%2F

        //Shorten The Link

        //Manually
        String shortLink = "https://cineprime.page.link/?"
                + "link=https://cineprime.app/myrefer.php?Id=" + movie_id
                + "&apn=" + getPackageName()
                + "&ibi=com.CinePrime"
        ...
        System.out.println("MovieDetailsActivity2 ==> ShortLink ==> " + shortLink);
    ...
    private void fetchDownloadOptions(ItemMovie downloadItemMovie) {
        ...
        if (pDialog == null || !pDialog.isShowing()) {
            pDialog = new ProgressDialog(MovieDetailsActivity2.this);
        ...
        DownloadHelper downloadHelper = DownloadHelper.forHls(MovieDetailsActivity2.this, Uri.parse(itemMovie.getMovieUrl()), dataSourceFactory, new DefaultRenderersFactory(MovieDetailsActivity2.this));
    ...
    private void showDownloadOptionsDialog(DownloadHelper helper, List<TrackKey> trackKeys, ItemMovie downloadItemMovie) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(MovieDetailsActivity2.this);
        ...
        ArrayAdapter arrayAdapter = new ArrayAdapter<String>(
                MovieDetailsActivity2.this, // Context
    ...
    private void getDetails() {
        ...
        client.post(Constant.MOVIE_DETAILS_URL1, params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    JSONObject mainJson = new JSONObject(result);
                    System.out.println("MovieDetailsActivity2 ==> mainJSON ==> " + mainJson);
                    ...
                    if (objJson.length() > 0) {
                        if (objJson.has(Constant.STATUS)) {
                            ...
                            if (TextUtils.isEmpty(objJson.optString(Constant.TRAILER_URL)))
                                ...
                                Picasso.with(MovieDetailsActivity2.this).load(objJson.optString(Constant.MOVIE_IMAGE)).into(imgTrailer);
                            }
                    ...
                    if (arrayCast.length() > 0) {
                        ...
                        recyclerCast.setAdapter(new MovieCastAdapter(MovieDetailsActivity2.this, castModelArrayList, false));
                    }
    ...
    private void displayData() {
        ...
        if (!mListItemRelated.isEmpty()) {
            homeMovieAdapter = new HomeMovieListAdapter(MovieDetailsActivity2.this, mListItemRelated, false);
            ...
            homeMovieAdapter.setOnItemClickListener(position -> {
                ...
                Intent intent = new Intent(MovieDetailsActivity2.this, MovieDetailsActivity2.class);
    ...
    public void onBackPressed() {
        if (isFullScreen) {
            ...
            ExoPlayerFragment fragment = (ExoPlayerFragment) fm.findFragmentById(R.id.frame_layout_main);
//            requestWindowFeature(Window.FEATURE_NO_TITLE);
            this.getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
            assert fragment != null;
            fragment.fullScreen();
        } else {
            Intent intent = new Intent(MovieDetailsActivity2.this, MainActivity.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent);
            finish();
        }
