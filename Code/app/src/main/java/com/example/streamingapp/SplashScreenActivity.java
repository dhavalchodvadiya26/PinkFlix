...
public class SplashScreenActivity extends Activity {
                ...
                if (myApplication.getIsIntroduction()) {
                    if (isLoginDisable && myApplication.getIsLogin()) {
                        ...
                        if (Id.equals("")) {
                            ...
                            intent = new Intent(getApplicationContext(), MovieDetailActivity1.class);
                        ...
                        Toast.makeText(SplashScreenActivity.this, getString(R.string.user_disable), Toast.LENGTH_SHORT).show();
                        Intent intent;
                        if (Id.equals("")) {
    ...
    private void checkLicense() {
        ...
        System.out.println("SplashScreenActivity ==> checkLicense() ==> params ==> " + params);
        ...
        client.post(Constant.APP_UPDATE_CHECK, params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                System.out.println("SplashScreenActivity ==> checkLicense() ==> result ==> " + result);
                try {
