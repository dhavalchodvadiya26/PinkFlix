...
public class PayPalPaymentActivity extends AppCompatActivity {
    ...
    private void buyPayPal() {
        ...
        Intent intentPay = new Intent(PayPalPaymentActivity.this, PaymentActivity.class);
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                if (confirm != null) {
                    try {
                        ...
                        if (NetworkUtils.isConnected(PayPalPaymentActivity.this)) {
                            new Transaction(PayPalPaymentActivity.this)
