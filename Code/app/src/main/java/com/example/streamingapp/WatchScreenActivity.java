...
import com.example.adapter.WatchMovieVideoListAdapter2;
...
public class WatchScreenActivity extends AppCompatActivity {
    ...
    private WatchMovieVideoListAdapter2 latestMovieAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (NetworkUtils.isConnected(WatchScreenActivity.this)) {
            getToWatchList();
        } else {
    ...
    public void showToast(String msg) {
        Toast.makeText(WatchScreenActivity.this, msg, Toast.LENGTH_SHORT).show();
    }
                ...
                try {
                    ...
                    if (mainJson.optString("status_code").equalsIgnoreCase("200")) {
                        ...
                        for (int i = 0; i < recentArray.length(); i++) {
                            ...
                            latestMovieAdapter = new WatchMovieVideoListAdapter2(WatchScreenActivity.this, recentList, false);
                            ...
                            latestMovieAdapter.setOnItemClickListener(position ->
                            {
                                ...
                                Intent intent = new Intent(WatchScreenActivity.this, MovieDetailActivity1.class);
