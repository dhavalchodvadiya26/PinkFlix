 ...
 */
public class OfflineMoviePlayerActivity extends AppCompatActivity implements View.OnClickListener, VideoRendererEventListener, PlaybackPreparer, PlayerControlView.VisibilityListener {
    ...
    private void initExoplayer() {
        ...
        DownloadRequest downloadRequest = MyApplication.getInstance().getDownloadTracker().getDownloadRequest(Uri.parse(offlineVideoLink));
    ...
    public void finishActivity() {
        OfflineMoviePlayerActivity.this.finish();
    }
