...
public class SearchActivity extends AppCompatActivity {
    ...
    HomeMovieVideoListAdapter movieAdapter;
    HomeShowVideoListAdapter showAdapter;
    HomeSportVideoListAdapter sportAdapter;
    HomeTvVideoListAdapter tvAdapter;
    ...
    private void displayData() {
        ...
        if (!movieList.isEmpty()) {
            movieAdapter = new HomeMovieVideoListAdapter(SearchActivity.this, movieList, false);
            ...
            movieAdapter.setOnItemClickListener(new RvOnClickListener() {
                ...
                public void onItemClick(int position) {
                    ...
                    Intent intent = new Intent(SearchActivity.this, MovieDetailActivity1.class);
        ...
        if (!showList.isEmpty()) {
            showAdapter = new HomeShowVideoListAdapter(SearchActivity.this, showList, false);
            ...
            showAdapter.setOnItemClickListener(new RvOnClickListener() {
                ...
                public void onItemClick(int position) {
                    ...
                    Intent intent = new Intent(SearchActivity.this, ShowVideoDetailsActivity.class);
        ...
        if (!sportList.isEmpty()) {
            sportAdapter = new HomeSportVideoListAdapter(SearchActivity.this, sportList);
            ...
            sportAdapter.setOnItemClickListener(new RvOnClickListener() {
                ...
                public void onItemClick(int position) {
                    ...
                    Intent intent = new Intent(SearchActivity.this, SportVideoDetailsActivity.class);
        ...
        if (!tvList.isEmpty()) {
            tvAdapter = new HomeTvVideoListAdapter(SearchActivity.this, tvList);
            ...
            tvAdapter.setOnItemClickListener(new RvOnClickListener() {
                ...
                public void onItemClick(int position) {
                    ...
                    Intent intent = new Intent(SearchActivity.this, TvVideoDetailsActivity.class);
                    intent.putExtra("Id", tvId);
                    startActivity(intent);
                }
            });
