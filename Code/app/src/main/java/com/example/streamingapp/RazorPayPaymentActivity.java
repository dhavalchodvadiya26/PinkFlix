...
public class RazorPayPaymentActivity extends AppCompatActivity implements PaymentResultListener {
    ...
    private void goToHome() {
        Intent intent1 = new Intent(RazorPayPaymentActivity.this, MainActivity.class);
...
//            preFill.put("email", myApplication.getUserEmail());
    ...
    private void showError(String Title) {
        new AlertDialog.Builder(RazorPayPaymentActivity.this)
    ...
    public void onPaymentSuccess(String razorpayPaymentID) {
        ...
        try {
            if (NetworkUtils.isConnected(RazorPayPaymentActivity.this)) {
                DialogUtil.AlertBox(RazorPayPaymentActivity.this, getResources().getString(R.string.app_name), "Payment sucessfully.");
                new Transaction(RazorPayPaymentActivity.this)
