...
import com.example.itemmodels.ItemPaymentSetting;
...
public class SelectSubscriptionPlanActivity extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (NetworkUtils.isConnected(SelectSubscriptionPlanActivity.this)) {
            getPaymentSetting();
        } else {
            Toast.makeText(SelectSubscriptionPlanActivity.this, getString(R.string.conne_msg1), Toast.LENGTH_SHORT).show();
        }

    }

    private void startRazorPayPayment() {
        Intent intentRazor = new Intent(SelectSubscriptionPlanActivity.this, RazorPayPaymentActivity.class);
