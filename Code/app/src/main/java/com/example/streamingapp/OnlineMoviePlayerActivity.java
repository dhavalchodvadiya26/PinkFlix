...
public class OnlineMoviePlayerActivity extends AppCompatActivity implements View.OnClickListener, PlaybackPreparer, PlayerControlView.VisibilityListener, DownloadTracker.Listener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        System.out.println("OnlineMoviePlayerActivity ==> videoId ==> " + videoId);
        ...
        recyclerCast.setLayoutManager(new LinearLayoutManager(OnlineMoviePlayerActivity.this, LinearLayoutManager.HORIZONTAL, false));
    ...
    protected void createView() {
        ...
        rvRelated.setLayoutManager(new LinearLayoutManager(OnlineMoviePlayerActivity.this, LinearLayoutManager.HORIZONTAL, false));
    ...
    public void prepareView() {
        playerView.setLayoutParams(
                new PlayerView.LayoutParams(
                        ...
                        // or ViewGroup.LayoutParams.WRAP_CONTENT,
                        ScreenUtils.convertDIPToPixels(OnlineMoviePlayerActivity.this, playerHeight)));
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.btnWatchList2:
                if (NetworkUtils.isConnected(OnlineMoviePlayerActivity.this)) {
                    if (myApplication.getIsLogin())
                        addToWatchList();
                    else {
                        PrettyDialog pDialog = new PrettyDialog(OnlineMoviePlayerActivity.this);
                        pDialog
                                ...
                                .addButton(
                                        ...
                                        () -> {
                                            pDialog.dismiss();
                                            startActivity(new Intent(OnlineMoviePlayerActivity.this, SignInScreenActivity.class));
                                        }).addButton(
...
//        params.put("data", API.toBase64(jsObj.toString()));
    ...
    private void fetchDownloadOptions() {
        ...
        if (pDialog == null || !pDialog.isShowing()) {
            pDialog = new ProgressDialog(OnlineMoviePlayerActivity.this);
        ...
        DownloadHelper downloadHelper = DownloadHelper.forHls(OnlineMoviePlayerActivity.this, Uri.parse(itemMovie.getMovieUrl()), dataSourceFactory, new DefaultRenderersFactory(OnlineMoviePlayerActivity.this));
    ...
    private void showDownloadOptionsDialog(DownloadHelper helper, List<TrackKey> trackKeyss) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(OnlineMoviePlayerActivity.this);
        ...
        ArrayAdapter arrayAdapter = new ArrayAdapter<String>(
                OnlineMoviePlayerActivity.this, // Context
...
//                        TrackGroupArray rendererTrackGroups = mappedTrackInfo.getTrackGroups(i);
    ...
    public void onBackPressed() {
        ...
        if (isScreenLandscape) {
            ...
            OnlineMoviePlayerActivity.this.finish();
            clearStartPosition();
            player.release();
            player.stop();
            super.onBackPressed();
...
//                showControls();
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                        ...
                        if (objJson.has(Constant.STATUS)) {
                            ...
                            if (TextUtils.isEmpty(objJson.optString(Constant.TRAILER_URL)))
                                ...
                                layoutTrailer.setOnClickListener(v -> {
                                    if (isMovie) {
                                        DownloadedVideosFragment downloadFragment= DownloadedVideosFragment.newInstance(objJson.optString(Constant.TRAILER_URL), false);
                                ...
                                Picasso.with(OnlineMoviePlayerActivity.this).load(objJson.optString(Constant.MOVIE_IMAGE)).into(imgTrailer);
                            }
                    ...
                    if (arrayCast.length() > 0) {
                        ...
                        recyclerCast.setAdapter(new MovieStarCastAdapter(OnlineMoviePlayerActivity.this, castModelArrayList, false));
                    }
    ...
    private void displayData() {
        ...
        if (!mListItemRelated.isEmpty()) {
            homeMovieAdapter = new HomeMovieVideoListAdapter(OnlineMoviePlayerActivity.this, mListItemRelated, false);
            ...
            homeMovieAdapter.setOnItemClickListener(position -> {
                ...
                Intent intent = new Intent(OnlineMoviePlayerActivity.this, MovieDetailActivity1.class);
