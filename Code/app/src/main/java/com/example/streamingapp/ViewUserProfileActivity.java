...
public class ViewUserProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        txtMyAccount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (myApplication.getIsLogin()) {
                    Intent intenttransaction = new Intent(ViewUserProfileActivity.this, DashboardActivity.class);
        ...
        txtWatchList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (myApplication.getIsLogin()) {
                    Intent intentProfile = new Intent(ViewUserProfileActivity.this, WatchScreenActivity.class);
        ...
        txtTransaction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (myApplication.getIsLogin()) {
                    Intent intenttransaction = new Intent(ViewUserProfileActivity.this, TransactionListActivity.class);
                    startActivity(intenttransaction);
                } else {
                    showAlert();
                }
        ...
        txtMemberShip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (myApplication.getIsLogin()) {
                    startActivity(new Intent(ViewUserProfileActivity.this, SubscriptionPlanActivity.class));
                } else
                    showAlert();
            }
        });
        ...
        txtHelp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (myApplication.getIsLogin()) {
                    startActivity(new Intent(ViewUserProfileActivity.this, TechnicalHelpActivity.class));
                } else
                    showAlert();
            }
        });
    ...
    private void login() {
        startActivity(new Intent(ViewUserProfileActivity.this, SignInScreenActivity.class));
        finish();
    }
...
//                                    dismissProgressDialog();
    ...
    public void gotoSetting(View v) {
        startActivity(new Intent(ViewUserProfileActivity.this, SettingActivity.class));
    }
