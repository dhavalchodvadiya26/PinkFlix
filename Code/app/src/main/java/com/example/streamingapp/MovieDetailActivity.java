...
public class MovieDetailActivity extends AppCompatActivity implements View.OnClickListener, DialogUtils.AlertDialogListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        rvRelated.setLayoutManager(new LinearLayoutManager(MovieDetailActivity.this, LinearLayoutManager.HORIZONTAL, false));
        ...
        if (NetworkUtils.isConnected(MovieDetailActivity.this)) {
            getDetails();
        } else {
        ...
        if ((mediaRouteMenuItem != null) && mediaRouteMenuItem.isVisible()) {
            new Handler().post(() -> {
                mIntroductoryOverlay = new IntroductoryOverlay.Builder(
                        MovieDetailActivity.this, mediaRouteMenuItem)
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    ...
                    if (objJson.length() > 0) {
                        if (objJson.has(Constant.STATUS)) {
                            ...
                            if (TextUtils.isEmpty(objJson.optString(Constant.TRAILER_URL)))
                                ...
                                Picasso.with(MovieDetailActivity.this).load(objJson.optString(Constant.MOVIE_IMAGE)).into(imgTrailer);
                            }
                    ...
                    if (arrayCast.length() > 0) {
                        ...
                        recyclerCast.setAdapter(new MovieStarCastAdapter(MovieDetailActivity.this, castModelArrayList, false));
                    }
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    ...
                    if (mainJson.optString("code").equalsIgnoreCase("200")) {
                        PrettyDialog pDialog = new PrettyDialog(MovieDetailActivity.this);
                        pDialog
    ...
    private void displayData() {
        ...
        if (!mListItemRelated.isEmpty()) {
            homeMovieAdapter = new HomeMovieVideoListAdapter(MovieDetailActivity.this, mListItemRelated, false);
    ...
    private void setPlayer() {
        if (itemMovie.getMovieUrl().isEmpty()) {
            ...
            switch (itemMovie.getMovieType()) {
                ...
                case "URL":
                    if (getIntent().getBooleanExtra("live", false)) {
                        ExoTvVideoPlayerFragment exoPlayerFragment = ExoTvVideoPlayerFragment.newInstance(itemMovie.getMovieUrl(), false);
                        ...
                        ExoVideoPlayerFragment exoVideoPlayerFragment = ExoVideoPlayerFragment.newInstance(itemMovie.getMovieUrl(), false);
                        exoVideoPlayerFragment.setItemMovie(itemMovie);
                        fragmentManager.beginTransaction().replace(R.id.playerSection, exoVideoPlayerFragment).commitAllowingStateLoss();
                    }
                    Remember.putString(Constant.MOVIE_FROM, "movie");
    ...
    public void onClick(View v) {
                ...
                if (myApplication.getIsLogin())
                    ...
                    pDialog
                            ...
                            .addButton(
                                    ...
                                    () -> {
                                        pDialog.dismiss();
                                        startActivity(new Intent(MovieDetailActivity.this, SignInScreenActivity.class));
                                    }).addButton(
        ...
        if (v == btnDisLike) {
            ...
            startActivity(new Intent(getApplicationContext(), SubscriptionPlanActivity.class).putExtra("rental", "true"));
    ...
    private void exoVideoDownloadDecision(ExoDownloadState exoDownloadState) {
        System.out.println("MovieDetailActivity ==> Movie URL ==> " + itemMovie.getMovieUrl());
        System.out.println("MovieDetailActivity ==> Movie URL2 ==> " + Remember.getString("movie_url", "0"));
    ...
    private void fetchDownloadOptions() {
        ...
        DownloadHelper downloadHelper = DownloadHelper.forHls(MovieDetailActivity.this, Uri.parse(itemMovie.getMovieUrl()), dataSourceFactory, new DefaultRenderersFactory(MovieDetailActivity.this));
    ...
    private void showDownloadOptionsDialog(DownloadHelper helper, List<TrackKey> trackKeyss) {
        ...
        ArrayAdapter arrayAdapter = new ArrayAdapter<String>(
                MovieDetailActivity.this, // Context
