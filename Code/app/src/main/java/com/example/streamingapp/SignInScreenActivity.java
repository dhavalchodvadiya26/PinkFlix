...
public class SignInScreenActivity extends AppCompatActivity implements View.OnClickListener {
    @NotEmpty
    @Email
    EditText edtEmail;
    @NotEmpty
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnRegister.setOnClickListener(v -> {
            Intent intent1 = new Intent(SignInScreenActivity.this, SignUpScreenActivity.class);
            intent1.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent1);
        });

        btnForgotPass.setOnClickListener(v -> {
            Intent intent13 = new Intent(SignInScreenActivity.this, ForgotPasswordActivity.class);
    ...
    public void doFacebookLogin() {
        ...
        LoginManager.getInstance().registerCallback(callbackManager, new FacebookCallback<LoginResult>() {
            ...
            public void onCancel() {
                Toast.makeText(SignInScreenActivity.this, "Something problem in facebook login. try again", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onError(FacebookException error) {
                Toast.makeText(SignInScreenActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void callFacebookApi(String strName, String phone, String fbUserID) {
        ...
        client.post(Constant.LOGIN_WITH_FACEBOOK_URL, params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                        ...
                        if (Constant.GET_SUCCESS_MSG == 0) {
                            ...
                            try {
                                ...
                                if (arrUserList != null &&
                                    ...
                                    SignInScreenActivity.this.strName = objUser.getString(Constant.USER_NAME);
                ...
                Intent i = new Intent(SignInScreenActivity.this, MainActivity.class);
                startActivity(i);
                finish();
            }
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
                dismissProgressDialog();
                Toast.makeText(SignInScreenActivity.this, error.toString(), Toast.LENGTH_SHORT).show();
            }
...
//    }
    ...
    public void setResult() {
        ...
        if (Constant.GET_SUCCESS_MSG == 0) {
            AlertDialog.Builder builder = new AlertDialog.Builder(SignInScreenActivity.this);
            ...
            if (isFromOtherScreen) {
                ...
                Intent intent = new Intent(SignInScreenActivity.this, aClass);
    ...
    public void showToast(String msg) {
        Toast.makeText(SignInScreenActivity.this, msg, Toast.LENGTH_SHORT).show();
    }
