...
public class HomeRecentMovieListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public HomeRecentMovieListAdapter(Context context, ArrayList<ItemRecent> dataList) {
