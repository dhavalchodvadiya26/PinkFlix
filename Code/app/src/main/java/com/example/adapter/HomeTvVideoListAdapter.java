...
public class HomeTvVideoListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public HomeTvVideoListAdapter(Context context, ArrayList<ItemTV> dataList) {
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        Picasso.with(mContext).load(singleItem.getTvImage()).into(holder.image);
