...
public class SportVideoListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SportVideoListAdapter(Context context, ArrayList<ItemSport> dataList) {
    ...
    public SportVideoListAdapter(Context context, ArrayList<ItemSport> dataList, String name) {
        this.dataList = dataList;
        this.mContext = context;
        columnWidth = NetworkUtils.getScreenWidth(mContext);
        isRTL = Boolean.parseBoolean(mContext.getString(R.string.isRTL));
