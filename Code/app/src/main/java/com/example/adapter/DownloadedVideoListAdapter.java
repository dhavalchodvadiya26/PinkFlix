...
public class DownloadedVideoListAdapter extends RecyclerView.Adapter<DownloadedVideoListAdapter.MyViewHolder> { //implements Filterable
    ...
    public DownloadedVideoListAdapter(Context context, List<Download> videosList, DownloadedFragment downloadActivity) {
    ...
    @Override
    public DownloadedVideoListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_downloaded_video, parent, false);
        return new DownloadedVideoListAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(DownloadedVideoListAdapter.MyViewHolder holder, int position, List<Object> payloads) {
...
//                    String downloadInMb = AppUtil.getProgressDisplayLine(download.getBytesDownloaded(), downloadRequest.data.length);
    ...
    @Override
    public void onBindViewHolder(final DownloadedVideoListAdapter.MyViewHolder holder, final int position) {
