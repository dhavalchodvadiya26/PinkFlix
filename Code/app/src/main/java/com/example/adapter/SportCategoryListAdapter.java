...
public class SportCategoryListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SportCategoryListAdapter(Context context, ArrayList<ItemSportCategory> dataList) {
