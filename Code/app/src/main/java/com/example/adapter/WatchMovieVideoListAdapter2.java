...
public class WatchMovieVideoListAdapter2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public WatchMovieVideoListAdapter2(Context context, ArrayList<ItemMovie> dataList, boolean isHomeMore) {
