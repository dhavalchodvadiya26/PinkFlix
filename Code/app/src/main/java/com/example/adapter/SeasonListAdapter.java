...
public class SeasonListAdapter extends ArrayAdapter<ItemSeason> {

    private ArrayList<ItemSeason> dataList;
    private Context mContext;

    public SeasonListAdapter(@NonNull Context context, int resource, @NonNull ArrayList<ItemSeason> objects) {
