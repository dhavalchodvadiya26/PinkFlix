...
public class HomeMovieLandscapListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public HomeMovieLandscapListAdapter(Context context, ArrayList<ItemMovie> dataList, boolean isHomeMore) {
