...
public class HomeSportVideoListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public HomeSportVideoListAdapter(Context context, ArrayList<ItemSport> dataList) {
