...
public class WatchMovieListAdapter2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public WatchMovieListAdapter2(Context context, ArrayList<ItemMovie> dataList, boolean isHomeMore) {
