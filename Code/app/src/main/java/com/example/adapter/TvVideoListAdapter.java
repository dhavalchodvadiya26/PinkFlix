...
public class TvVideoListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TvVideoListAdapter(Context context, ArrayList<ItemTV> dataList) {
