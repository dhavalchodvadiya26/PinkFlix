...
public class HomeLandscapeMovieListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public HomeLandscapeMovieListAdapter(Context context, ArrayList<ItemMovie> dataList, boolean isHomeMore) {
