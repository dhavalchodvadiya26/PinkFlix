...
public class SportVideosCategoryListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SportVideosCategoryListAdapter(Context context, ArrayList<ItemSportCategory> dataList) {
