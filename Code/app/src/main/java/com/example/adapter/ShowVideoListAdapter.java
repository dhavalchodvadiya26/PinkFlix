...
public class ShowVideoListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ShowVideoListAdapter(Context context, ArrayList<ItemShow> dataList) {
