...
public class MovieLanguageListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MovieLanguageListAdapter(Context context, ArrayList<ItemLanguage> dataList) {
