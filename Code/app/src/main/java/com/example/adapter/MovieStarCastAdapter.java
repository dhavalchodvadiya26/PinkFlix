...
public class MovieStarCastAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MovieStarCastAdapter(Context context, ArrayList<CastModel> dataList, boolean isHomeMore) {
