...
public class SubscriptionTransactionListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private ArrayList<ItemSubscription> dataList;


    public SubscriptionTransactionListAdapter(ArrayList<ItemSubscription> dataList) {
