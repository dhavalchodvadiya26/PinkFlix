...
public class HomeShowListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public HomeShowListAdapter(Context context, ArrayList<ItemShow> dataList, boolean isHomeMore) {
