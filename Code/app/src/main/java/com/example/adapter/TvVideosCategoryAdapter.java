...
public class TvVideosCategoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private ArrayList<ItemTVCategory> dataList;
    private Context mContext;
    private RvOnClickListener clickListener;
    private int row_index = -1;

    public TvVideosCategoryAdapter(Context context, ArrayList<ItemTVCategory> dataList) {
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        final ItemTVCategory singleItem = dataList.get(position);
