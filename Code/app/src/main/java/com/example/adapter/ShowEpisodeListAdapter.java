...
public class ShowEpisodeListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ShowEpisodeListAdapter(Context context, ArrayList<ItemEpisode> dataList, boolean isPurchased) {
