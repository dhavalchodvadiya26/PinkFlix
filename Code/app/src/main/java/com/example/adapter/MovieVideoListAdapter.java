...
public class MovieVideoListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MovieVideoListAdapter(Context context, ArrayList<ItemMovie> dataList) {
