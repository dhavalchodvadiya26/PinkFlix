...
public class Remember {
     ...
     *
     * @param context
     * 		the context to use. Using the application context is fine here.
     * @param sharedPrefsName
     * 		the name of the shared prefs file to use
     ...
     * 		the key
     * @param value
     * 		the value to put. This MUST be a type supported by SharedPreferences. Which is to say: one of (float,
     * 		int, long, String, boolean).
     * @param callback
     * 		the callback to fire. The callback will be fired on the UI thread,
