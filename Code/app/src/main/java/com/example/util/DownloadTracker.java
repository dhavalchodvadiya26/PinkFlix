...
public class DownloadTracker {
    ...
    private final class StartDownloadDialogHelper
        ...
        public void onPrepared(DownloadHelper helper) {
            ...
            trackSelectionDialog = TrackSelectionDialog.createForMappedTrackInfoAndParameters(/* titleId= */ R.string.exo_download_description, mappedTrackInfo, trackSelectorParameters,
        ...
        private void startDownload(DownloadRequest downloadRequest) {
            DownloadService.sendAddDownload(context, DemoDownloadService.class, downloadRequest, /* foreground= */ false);
        }
