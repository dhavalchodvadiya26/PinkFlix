...
public class ExoTvVideoPlayerFragment extends Fragment {
    ...
    public static ExoTvVideoPlayerFragment newInstance(String url, boolean isTrailer, Long duration) {
        ExoTvVideoPlayerFragment f = new ExoTvVideoPlayerFragment();
    ...
    public static ExoTvVideoPlayerFragment newInstance(String url, boolean isTrailer) {
        ExoTvVideoPlayerFragment f = new ExoTvVideoPlayerFragment();
        Bundle args = new Bundle();
        args.putString(streamUrl, url);
        args.putBoolean(trailer, isTrailer);
