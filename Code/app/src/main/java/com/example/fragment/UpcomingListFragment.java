...
public class UpcomingListFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        upcoming_text=rootView.findViewById(R.id.upcoming_text);
        upcoming_text.setText("Upcoming Movies");
    ...
    private void getMovie(String mFilter) {
        ...
        params.put("data", "Upcoming");
        params.put("page", pageIndex);
        client.post(Constant.UPCOMING_MOVIES, params, new AsyncHttpResponseHandler() {
            @Override
            public void onStart() {
                super.onStart();
                if (isFirst)
