...
public class PremiumMovieCategoryListFragment extends Fragment {
    ...
    private void displayData() {
        ...
        if (!movieList.isEmpty()) {
            movieAdapter = new HomeMovieVideoListAdapter(getContext(), movieList, false);
            ...
            movieAdapter.setOnItemClickListener(new RvOnClickListener() {
                ...
                public void onItemClick(int position) {
                    ...
                    Intent intent = new Intent(getContext(), MovieDetailActivity1.class);
        ...
        if (!showList.isEmpty()) {
            showAdapter = new HomeShowVideoListAdapter(getContext(), showList, false);
            ...
            showAdapter.setOnItemClickListener(new RvOnClickListener() {
                ...
                public void onItemClick(int position) {
                    ...
                    Intent intent = new Intent(getContext(), ShowVideoDetailsActivity.class);
        ...
        if (!sportList.isEmpty()) {
            sportAdapter = new HomeSportVideoListAdapter(getContext(), sportList);
            ...
            sportAdapter.setOnItemClickListener(new RvOnClickListener() {
                ...
                public void onItemClick(int position) {
                    ...
                    Intent intent = new Intent(getContext(), SportVideoDetailsActivity.class);
        ...
        if (!tvList.isEmpty()) {
            tvAdapter = new HomeTvVideoListAdapter(getContext(), tvList);
            ...
            tvAdapter.setOnItemClickListener(new RvOnClickListener() {
                ...
                public void onItemClick(int position) {
                    ...
                    Intent intent = new Intent(getContext(), TvVideoDetailsActivity.class);
                    intent.putExtra("Id", tvId);
                    startActivity(intent);
                }
            });
