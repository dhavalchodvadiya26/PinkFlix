...
import com.example.streamingapp.EmbeddedMoviePlayerActivity;
import com.example.streamingapp.R;
import com.squareup.picasso.Picasso;

public class EmbeddedImageListFragment extends Fragment {


    public static EmbeddedImageListFragment newInstance(String streamUrl, String imageCover, boolean isPlayVisible) {
        EmbeddedImageListFragment f = new EmbeddedImageListFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        imagePlay.setOnClickListener(v -> {
            if (!streamUrl.isEmpty()) {
                Intent intent = new Intent(getActivity(), EmbeddedMoviePlayerActivity.class);
