...
import com.example.adapter.LanguageListAdapter;
...
public class LanguageListFragment extends Fragment implements FilterDialog.FilterDialogListener {
    ...
    public static LanguageListFragment newInstance(boolean isShow, String position) {
    ...
    private void displayData() {
        if (mListItem.size() == 0) {
            ...
            adapter = new LanguageListAdapter(getActivity(), mListItem);
