...
public class ExoVideoPlayerFragment extends Fragment {
    ...
    public static ExoVideoPlayerFragment newInstance(String url, boolean isTrailer) {
        ExoVideoPlayerFragment f = new ExoVideoPlayerFragment();
    ...
    public static ExoVideoPlayerFragment newInstance(String url, boolean isTrailer, Long duration) {
        ExoVideoPlayerFragment f = new ExoVideoPlayerFragment();
        Bundle args = new Bundle();
        args.putString(streamUrl, url);
        args.putBoolean(trailer, isTrailer);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
                ...
                if (!isTrailer) {
                    ...
                    pDialog
                            ...
                            .addButton(
                                    ...
                                    () -> {
                                        pDialog.dismiss();
                                        startActivity(new Intent(getActivity(), SignInScreenActivity.class));
                                    }).addButton(
        ...
        playerView.setControllerVisibilityListener(i -> {
            if (i == 0) {
                ...
                if (Remember.getString(Constant.MOVIE_FROM, "").equalsIgnoreCase("movie"))
                    ((MovieDetailActivity1) Objects.requireNonNull(getActivity())).hideShowBackButton(true);
                else
                    ((ShowVideoDetailsActivity) Objects.requireNonNull(getActivity())).hideShowBackButton(true);

            } else {
                if (Remember.getString(Constant.MOVIE_FROM, "").equalsIgnoreCase("movie"))
                    ((MovieDetailActivity1) Objects.requireNonNull(getActivity())).hideShowBackButton(false);
                else
                    ((ShowVideoDetailsActivity) Objects.requireNonNull(getActivity())).hideShowBackButton(false);
