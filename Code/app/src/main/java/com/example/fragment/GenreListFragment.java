...
import com.example.adapter.GenreListAdapter;
...
public class GenreListFragment extends Fragment implements FilterDialog.FilterDialogListener {
    ...
    public static GenreListFragment newInstance(boolean isShow) {
        GenreListFragment f = new GenreListFragment();
    ...
    private void displayData() {
        if (mListItem.size() == 0) {
            ...
            adapter = new GenreListAdapter(getActivity(), mListItem);
