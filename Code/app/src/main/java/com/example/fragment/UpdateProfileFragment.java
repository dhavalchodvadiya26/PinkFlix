...
public class UpdateProfileFragment extends Fragment implements Validator.ValidationListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        imageAvtar = rootView.findViewById(R.id.imageAvtar);
        btnSubmit = rootView.findViewById(R.id.button_submit);
                    ...
                    if (jsonArray.length() > 0) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if (!userImage.isEmpty()) {
                                Picasso.with(getActivity()).load(userImage).placeholder(R.drawable.ic_v).into(imageAvtar);
                            }
                        }
                    } else {
                        mProgressBar.setVisibility(View.GONE);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == Config.RC_PICK_IMAGES && resultCode == RESULT_OK && data != null) {
            ...
            Picasso.with(getActivity()).load(uri).into(imageAvtar);
            isImage = true;
        }
