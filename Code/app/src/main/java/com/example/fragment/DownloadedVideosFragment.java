...
import com.example.adapter.DownloadVideoAdapter;
...
public class DownloadedVideosFragment extends Fragment {
    ...
    private DownloadVideoAdapter downloadedVideoAdapter;
    ...
    public static DownloadedVideosFragment newInstance(String url, boolean isTrailer) {
        DownloadedVideosFragment f = new DownloadedVideosFragment();
    ...
    private void loadVideos() {
        ...
        if (downloadedVideoList.size() != 0) {
            ...
            downloadedVideoAdapter = new DownloadVideoAdapter(getActivity(), downloadedVideoList, DownloadedVideosFragment.this);
    ...
    public void openBottomSheet(Download download) {
        ...
        llDownloadDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Fragment myFragment = new DownloadedVideosFragment();
                ...
                if (downloadedVideoList.size() != 0) {
                    ...
                    Fragment myFragment1 = new DownloadedVideosFragment();
